        ...
        const TCubeTiling* mmTilingData, TPipe *tPipeIn)
{
    ...
    weightGm.SetGlobalBuffer(GetLayerTensorAddr<DTYPE_WEIGHT_DEV_A8W4MSD>(curLayer, tiling->layerNum, weight));
    biasGm.SetGlobalBuffer(GetLayerTensorAddr<DTYPE_BIAS_A8W4MSD>(curLayer, tiling->layerNum, bias));
    scaleGm.SetGlobalBuffer(GetLayerTensorAddr<DTYPE_SCALE_DEV_A8W4MSD>(curLayer, tiling->layerNum, scale));
