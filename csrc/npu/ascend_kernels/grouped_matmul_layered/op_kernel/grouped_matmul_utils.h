...
#include "lib/matmul_intf.h"
  ...
  #endif
  #if defined(ORIG_DTYPE_X) && defined(ORIG_DTYPE_ALL_WEIGHT) && defined(DT_FLOAT8_E5M2) && \
      defined(DT_FLOAT8_E4M3FN) && \
      defined(DT_HIFLOAT8) && defined(DT_INT8) && defined(DT_FLOAT4_E2M1) && defined(DT_INT4) && \
      ((ORIG_DTYPE_X == DT_INT8 && ORIG_DTYPE_ALL_WEIGHT == DT_INT8) || \
       (ORIG_DTYPE_X == DT_HIFLOAT8 && ORIG_DTYPE_ALL_WEIGHT == DT_HIFLOAT8) || \
       ((ORIG_DTYPE_X == DT_FLOAT8_E5M2 || ORIG_DTYPE_X == DT_FLOAT8_E4M3FN) && \
        (ORIG_DTYPE_ALL_WEIGHT == DT_FLOAT8_E5M2 || ORIG_DTYPE_ALL_WEIGHT == DT_FLOAT8_E4M3FN)) || \
       (ORIG_DTYPE_X == DT_FLOAT4_E2M1 && ORIG_DTYPE_ALL_WEIGHT == DT_FLOAT4_E2M1) || \
       (ORIG_DTYPE_X == DT_INT4 && ORIG_DTYPE_ALL_WEIGHT == DT_INT4))
    #define V310_GMM_QUANT
    #if defined(ORIG_DTYPE_ALL_SCALE) && defined(DT_FLOAT8_E8M0) && ORIG_DTYPE_ALL_SCALE == DT_FLOAT8_E8M0
      #define V310_GMM_QUANT_MX
    #elif defined(ORIG_DTYPE_ALL_SCALE) && defined(DT_UINT64) && defined(DT_INT64) && \
        (ORIG_DTYPE_ALL_SCALE != DT_UINT64 && ORIG_DTYPE_ALL_SCALE != DT_INT64)
      #define V310_GMM_QUANT_MIX
      #define V310_GMM_QUANT_PERTENSOR_CUBE
      #if (ORIG_DTYPE_X != DT_INT8 && ORIG_DTYPE_ALL_SCALE == DT_FLOAT)
  ...
  #if defined(ORIG_DTYPE_X) && defined(ORIG_DTYPE_ALL_WEIGHT) && ORIG_DTYPE_X != ORIG_DTYPE_ALL_WEIGHT
    #if ((ORIG_DTYPE_X == DT_FLOAT16 || ORIG_DTYPE_X == DT_BF16) && \
         (ORIG_DTYPE_ALL_WEIGHT == DT_FLOAT8_E5M2 || ORIG_DTYPE_ALL_WEIGHT == DT_FLOAT8_E4M3FN || \
          ORIG_DTYPE_ALL_WEIGHT == DT_HIFLOAT8 || ORIG_DTYPE_ALL_WEIGHT == DT_INT8 || \
          ORIG_DTYPE_ALL_WEIGHT == DT_FLOAT4_E2M1 || ORIG_DTYPE_ALL_WEIGHT == DT_FLOAT || \
          ORIG_DTYPE_ALL_WEIGHT == DT_INT32 || ORIG_DTYPE_ALL_WEIGHT == DT_INT4)) || \
        (ORIG_DTYPE_X == DT_INT8 && (ORIG_DTYPE_ALL_WEIGHT == DT_INT4 || ORIG_DTYPE_ALL_WEIGHT == DT_INT32)) || \
        (ORIG_DTYPE_X == DT_FLOAT8_E4M3FN && \
         (ORIG_DTYPE_ALL_WEIGHT == DT_FLOAT4_E2M1 || ORIG_DTYPE_ALL_WEIGHT == DT_FLOAT))
...
#if defined(ORIG_DTYPE_X) && defined(ORIG_DTYPE_ALL_WEIGHT) && defined(ORIG_DTYPE_Y) && defined(DT_INT8) && \
    defined(DT_BF16) && defined(DT_INT4)
  #if ORIG_DTYPE_X == ORIG_DTYPE_ALL_WEIGHT
    ...
    #if ORIG_DTYPE_X == DT_INT8 && ORIG_DTYPE_ALL_WEIGHT == DT_INT4
    ...
    #define MM_DTYPE_Y DTYPE_Y
      ...
      #undef DTYPE_ALL_SCALE
      #define DTYPE_ALL_SCALE bfloat16_t
  #elif defined(GMM_ANTI_QUANT_A8W4_MSD_OUT_FP16)
      #undef DTYPE_ALL_SCALE
      #define DTYPE_ALL_SCALE float
  #endif
#endif
...
constexpr int32_t MKN_LIST_LEN = 128;  // 128: predefined array length
...
#if ((defined(__CCE_AICORE__) && __CCE_AICORE__ == 220) || (defined(__NPU_ARCH__) && (__NPU_ARCH__ == 3003 || __NPU_ARCH__ == 3113))) && \
    defined(ORIG_DTYPE_X) && defined(ORIG_DTYPE_ALL_WEIGHT) &&         \
    ORIG_DTYPE_X == DT_INT8 && ORIG_DTYPE_ALL_WEIGHT == DT_INT8
