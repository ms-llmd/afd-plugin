        ...
        const TCubeTiling* mmTilingData, TPipe *tPipeIn)
{
    ...
    scaleGm.SetGlobalBuffer(GetLayerTensorAddr<DTYPE_SCALE_DEV_A8W4>(curLayer, tiling->layerNum, scale));
    scaleGmF32.SetGlobalBuffer(GetLayerTensorAddr<float>(curLayer, tiling->layerNum, scale));
