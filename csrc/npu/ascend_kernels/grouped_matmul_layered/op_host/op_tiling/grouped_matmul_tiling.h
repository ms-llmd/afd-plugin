...
TILING_DATA_FIELD_DEF(uint32_t, layerNum);  // layered: all_* list length, bounds-checks the device layer_index
END_TILING_DATA_DEF;
...
TILING_DATA_FIELD_DEF(uint32_t, layerNum);  // layered: all_* list length
END_TILING_DATA_DEF;
...
REGISTER_TILING_DATA_CLASS(GroupedMatmulLayered, GMMTilingData)
